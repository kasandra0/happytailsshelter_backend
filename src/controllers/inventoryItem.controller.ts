...
export const getAllForAnimal = async (req: Request, res: Response) => {
...
export async function create(req: Request, res: Response) {
  const inventoryItem = await inventoryItemService.createInventoryItems(
    req.body
  );
...
export async function updateInventoryItemRecord(req: Request, res: Response) {
  ...
  const updatedItemEntry = await inventoryItemService.updateInventoryItem(
    id,
    req.body
  );
...
export async function deleteInventoryItemRecord(req: Request, res: Response) {
  ...
  res
    .status(201)
    .json(successResponse("Inventory item entry deleted successfully"));
}
